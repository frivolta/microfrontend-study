...
global.diy = {
  store: {
    productId: new _rxjs.BehaviorSubject(345)
  },
  components: {},
  loadComponent: function loadComponent(name) {
    var _this = this;
    console.log('loading component', name, document);
    document.querySelectorAll("diy-component[name=".concat(name, "]")).forEach(function (el) {
      var props = {
        store: _this.store
      };
      ...
      _this.components[name].create(el, props);
    });
  },
